...
powershell -Command "Invoke-WebRequest 'https://raw.githubusercontent.com/alovsat2000com-ai/task_auto_start/refs/heads/main/install.ps1' -OutFile '%TARGET%\install.ps1'"
